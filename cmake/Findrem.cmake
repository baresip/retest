...
find_path(REM_INCLUDE_DIR rem.h HINTS ../rem/include ${PC_LIBREM_INCLUDEDIR} ${PC_LIBREM_INCLUDE_DIRS})

find_library(REM_LIBRARY NAMES rem librem HINTS ../rem ${PC_LIBREM_LIBDIR} ${PC_LIBREM_LIBRARY_DIRS})
